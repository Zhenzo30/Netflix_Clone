    ...
    return (
        <div className="fixed top-0 w-full flex justify-between px-12 py-4 bg-transparent transition-colors duration-1000 z-50">
            ...
            <div className="flex gap-[15px] items-center">
                ...
                />
                <DropdownMenu>
                    {/* Se quitó asChild y el button, ahora le damos estilo directamente al Trigger */}
                    <DropdownMenuTrigger className="bg-transparent border-none p-0 m-0 cursor-pointer outline-none">
                        <Image  
